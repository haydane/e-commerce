        ...
        <div id="side-panel" style={{color: "#fff"}}>
            ...
            <div className="side-panel-wrap">
                <div className="widget clearfix">
                    ...
                    <a  className="button button-rounded t400 btn-block center si-colored noleftmargin si-facebook">Facebook</a>
                    <a  className="button button-rounded t400 btn-block center si-colored noleftmargin si-gplus">Google</a>
                    ...
                    <form id="login-form" name="login-form" className="nobottommargin" action="#" method="post">
                        <div className="col_full">
                            <label htmlFor="login-form-username" className="t400">Username:</label>
                            <input type="text" id="login-form-username" name="login-form-username" value="" className="form-control" />
                        </div>
                        <div className="col_full">
                            <label htmlFor="login-form-password" className="t400">Password:</label>
                        ...
                        <div className="col_full nobottommargin">
                            ...
                            <a  className="fright">Forgot Password?</a>
                        </div>
                    </form>
                </div>
            </div>
